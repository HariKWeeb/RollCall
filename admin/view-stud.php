...
// Fetch user data from the "students" table with class information
$sql = "SELECT s.rollno, s.student_name, s.phone, s.email, s.year, c.class_name
        FROM students s
        LEFT JOIN class_details c ON s.class_id = c.class_id";
